...
public final class AsymmetricRecyclerViewAdapter<T extends RecyclerView.ViewHolder>
  ...
  @Override public PhotoGridViewHolder<T> onCreateAsymmetricViewHolder(
      int position, ViewGroup parent, int viewType) {
    return new PhotoGridViewHolder<>(wrappedAdapter.onCreateViewHolder(parent, viewType));
  }

  @Override public void onBindAsymmetricViewHolder(
      PhotoGridViewHolder<T> holder, ViewGroup parent, int position) {
